    ...
    this.state = {
      data: [
        ...
        },
        {
          ...
          title: 'NewsAPI',
          tech:
            'React | Ajax | JavaScript (ES6) | HTML5 | Bulma (CSS framework) | SCSS | External API',
          description:
            'NEWS API is a news aggregator collating online news from different online papers across various countries. It was a pair coding project built in 2 days, and was both the first aggregating site we built, and our first real-world type practice with REACT.',
          type: 'React App',
