            ...
            <div className="columns is-multiline">
              ...
              <div className="exp">
                <div className="expga">
                  ...
                  This was a 12 weeks Software Engineering Immersive course that was focused on learning and developing the following software skills which are: HTML, CSS, GIT, JavaScript(ES6), Node.js, Express, React.js, Public and Restful API’s, Python, Django, MongoDB (NoSQL4), PostgreSQL, CRUD API and DOM manipulation, this was a combination of both Frontend and Backend.<br />
