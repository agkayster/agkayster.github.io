              ...
              <div className="column">
                ...
                <div className="contentcontainer">
                  ...
                  <div className="interest">
                    <p className="interestcontent">When I am not coding, I like to read books, watch movies, play chess and listen to good music as these activities provide a way for me to relax.<br />
                      <div className="thirdparagraph">
                    My knack for taking on both logical and creative challenges and making sure I overcome such challenges is what really makes me want to pursue a career in Software development, where logical and creative outcomes can come together to create new and exciting products for the world to experience.<br />
                      </div>
                    </p>
                  </div>
                </div>
