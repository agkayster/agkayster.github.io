        ...
        <div className="container">
          ...
          <div className={`navbar-menu${this.state.active ? ' is-active' : ''}`}>
            <div id="menu" className="navbar-start">
              ...
              <a onClick={this.toggleActive} href="#skills" className="navbar-item one">Skills</a>
            </div>

            <div><a onClick={this.toggleActive} href="#home" className="navbar-item"><img className="logo" src="https://imgur.com/07QH95m.png" alt="hat"/></a></div>
